...
module.exports.VANN = {
  preferredNamespacePrefix: rdf.namedNode(`${VANN_NAMESPACE}preferredNamespacePrefix`),
...
module.exports.SCHEMA_DOT_ORG = {
  ...
  PaymentStatusType: rdf.namedNode(`${SCHEMA_DOT_ORG_NAMESPACE}PaymentStatusType`),
};
