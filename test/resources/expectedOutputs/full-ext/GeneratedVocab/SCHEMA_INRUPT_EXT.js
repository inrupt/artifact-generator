...
/**
  ...
  at 'Monday, March 30, 2020 10:31 PM'.
...
const SCHEMA_INRUPT_EXT = {
  ...
  Person: new LitVocabTermRdfExt(_NS('Person'), localStorage, false)
    ...
    .addLabel(`Persona`, 'es')
    .addLabel(`Persona`, 'it')
    .addCommentNoLanguage(`A person (alive, dead, undead, or fictional).`)    .addComment(`Une personne (vivante, morte, mort-vivant ou fictive).`, 'fr')
...
,
  ...
  givenName: new LitVocabTermRdfExt(_NS('givenName'), localStorage, false)
    ...
    .addCommentNoLanguage(`Given name. In the U.S., the first name of a Person. This can be used along with familyName instead of the name property.`)    .addComment(`Prénom. Aux États-Unis, le prénom d’une personne. Ceci peut être utilisé avec familyName au lieu de la propriété name.`, 'fr')
...
,
  ...
  familyName: new LitVocabTermRdfExt(_NS('familyName'), localStorage, false)
    ...
    .addLabel(`Cognome`, 'it')
    .addCommentNoLanguage(`Family name. In the U.S., the last name of an Person. This can be used along with givenName instead of the name property.`)    .addComment(`Nom de famille. Aux États-Unis, le nom de famille d’une personne. Ceci peut être utilisé avec GivenName au lieu de la propriété name.`, 'fr')
