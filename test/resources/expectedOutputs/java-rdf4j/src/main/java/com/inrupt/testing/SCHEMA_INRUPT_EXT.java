/**
 * Generated by artifact generator [@inrupt/lit-artifact-generator], version [0.10.31]
 * as part of artifact: [generated-vocab-common-TEST], version: [3.2.1-SNAPSHOT]
 * on 'Tuesday, July 21, 2020 10:20 PM'.
 *
...
import com.inrupt.solid.common.term.Vocab;
import com.inrupt.solid.common.term.VocabTerm;
...
public class SCHEMA_INRUPT_EXT implements Vocab {
     ...
     */
    public static final VocabTerm Person = new VocabTerm(FULL_IRI("Person"), true)
     ...
     */
    public static final VocabTerm givenName = new VocabTerm(FULL_IRI("givenName"), true)
     ...
     */
    public static final VocabTerm familyName = new VocabTerm(FULL_IRI("familyName"), true)
     ...
     * Additional Name
     */
    public static final VocabTerm additionalName = new VocabTerm(FULL_IRI("additionalName"), true)
     ...
     */
    public static final VocabTerm newTerm = new VocabTerm(FULL_IRI("newTerm"), true)
